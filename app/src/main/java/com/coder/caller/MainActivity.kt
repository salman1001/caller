...
//    }
    ...
    class MainActivity : AppCompatActivity() {
        private var callLogModelArrayList: ArrayList<CallLogModel>? = null
...
//            swipeRefreshLayout = findViewById(R.id.activity_main_swipe_refresh_layout)
            rv_call_logs = findViewById<RecyclerView>(R.id.activity_main_rv)
        ...
        fun FetchCallLogs() {
          ...
          //  callLogModelArrayList!!.clear()
            ...
            while (cursor!!.moveToNext()) {
                ...
                Log.d(TAG, "FetchCallLogs: $str_number")
              //  text.append("phone number =  $str_number/n")
             ...
             //   Log.d(TAG, "FetchCallLogs: Called ")
...
//        }
        ...
        fun comprobar_Permisos_CALL_LOG(myContext: Context?, myActivity: Activity): Boolean {
            try {
